...
export default function LibraryStats({ stats }: Props) {
  ...
  const rows = [
    ...
    [t('libraryStats.multiStore', 'Games on multiple stores'), stats.multiStoreGames],
    [t('libraryStats.extraCopies', 'Extra copies across stores'), stats.extraCopies]
  ] as const
      ...
      title={
        <div>
          ...
          <p className="libraryStatsScope">
            {t('libraryStats.scope', 'Current view, including search and filters.')}
          </p>
